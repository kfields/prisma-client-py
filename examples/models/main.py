...
from __prisma__ import Prisma
from __prisma__.models import User
from __prisma__.errors import UnsupportedSubclassWarning
...
async def main() -> None:
    ...
    await test_create()
    await test_delete()
    await test_find_unique()
    await test_find_many()
